...
import 'package:booktickets/widgets/thick_contrainer.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid == true ? 167 : 161),
      child: Container(
        ...
        child: Column(
          children: [
            ...
            /*
            bottom part of the orange the card/ticket
             */
            Container(
              decoration: BoxDecoration(
                color: isColor == null ? Styles.orangeColor : Colors.white,
